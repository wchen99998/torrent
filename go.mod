...
require (
	...
	github.com/wchen99998/dht/v2 v2.24.2
...
require (
	...
	// Keep the umbrella module aligned with the split modules: the possum
	// workspace dependency still imports the pre-split genproto paths.
