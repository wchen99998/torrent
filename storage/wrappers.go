...
func (t *Torrent) FileState(fileIndex int) (FileState, error) {
	if t.TorrentImpl.FileState == nil {
		return FileState{}, fmt.Errorf("storage does not support file state")
	}
	return t.TorrentImpl.FileState(fileIndex)
}
